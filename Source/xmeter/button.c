...
static bit mod_down;
static bit set_down;
static bit mod_pressed;
static bit set_pressed;
static bit mod_set_pressed_send;
static bit mod_set_pressed;
static uint8_t set_down_sec;
static uint8_t mod_down_sec;
static uint8_t set_down_diff;
static uint8_t mod_down_diff;
static uint8_t mod_set_down_diff;
...
/*
EV_KEY_MOD_PRESS: mod down，之后在delay时间内up
EV_KEY_MOD_LPRESS mod down，之后在delay时间外up
EV_KEY_SET_PRESS: set down，之后在delay时间内up
EV_KEY_SET_LPRESS set down，之后在delay时间外up
EV_KEY_MOD_SET_PRESS：mod down & set down， 之后在delay时间内两个都up
EV_KEY_MOD_SET_LPRESS：mod down & set down， 之后在delay时间外两个都up
*/
